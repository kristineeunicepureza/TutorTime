...
public class Booking {
    ...
    private String studentId;  // Student who booked (from JWT)

    @Column(nullable = false)
    private String tutorId;    // Tutor being booked

    @Column(nullable = false)
    private String availabilityId;  // Reference to availability slot

    @Column(nullable = false)
    private String locationId;  // Location of tutoring
